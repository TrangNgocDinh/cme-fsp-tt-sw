...
function cme_mini_joint_distribution_last(joint_dist_tt,lower_bound,upper_bound)
...
% function plot_one_window_last(joint_dist_tt,lower_bound,upper_bound,name_plot)
